...
namespace BadConnection {
    ...
    public partial class MyDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Item, int Amount, float Price) {
...
namespace BadConnection.MyDBDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Item] = @Original_It" +
                "em) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Item], [Amount], [Price]) VALUES (@Item, @Amount, @Pr" +
                "ice);\r\nSELECT Id, Item, Amount, Price FROM [Table] WHERE (Id = SCOPE_IDENTITY())" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Item] = @Item, [Amount] = @Amount, [Price] = @Price WHERE (([Id] = @Original_Id) AND ([Item] = @Original_Item) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price));
SELECT Id, Item, Amount, Price FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BadConnection.Properties.Settings.Default.MyDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Item, Amount, Price FROM dbo.[Table]";
        ...
        public virtual int Fill(MyDBDataSet.TableDataTable dataTable) {
        ...
        public virtual MyDBDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDBDataSet.TableDataTable dataTable = new MyDBDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDBDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Item, int Original_Amount, float Original_Price) {
        ...
        public virtual int Insert(string Item, int Amount, float Price) {
            if ((Item == null)) {
        ...
        public virtual int Update(string Item, int Amount, float Price, int Original_Id, string Original_Item, int Original_Amount, float Original_Price, int Id) {
            if ((Item == null)) {
                throw new global::System.ArgumentNullException("Item");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Item, int Amount, float Price, int Original_Id, string Original_Item, int Original_Amount, float Original_Price) {
            return this.Update(Item, Amount, Price, Original_Id, Original_Item, Original_Amount, Original_Price, Original_Id);
        }
    }
